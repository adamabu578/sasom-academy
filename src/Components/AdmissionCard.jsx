...
const AdmissionCard = ({ index, heading, details, answer1, answer2 }) => {
  return (
    <div className="max-w-[550px] border-primary border-opacity-50 p-4 border-[1px] rounded-lg">
      <div className="flex items-center gap-5 mb-3">
        <div className="w-10 h-10 flex items-center justify-center text-white rounded-lg bg-primary">
          {index}
        </div>
        <h2>{heading}</h2>
      </div>
